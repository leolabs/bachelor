...
\usepackage[nameinlink]{cleveref} % Links zu Abbildungen und Tabellen
...
\geometry{a4paper, top=30mm, left=40mm, right=20mm, bottom=30mm} % nach Vorgabe
\linespread{1.5} 		% Zeilenabstand nach Vorgabe
\interfootnotelinepenalty10000 % Don't split footnotes over multiple pages
\widowpenalty10000 % Don't allow widowed lines
